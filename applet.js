...
ShortcutButton.prototype = {
  ...
  _init: function(_parent, app, appType) {
    ...
    this._draggable.connect('drag-begin', Lang.bind(this,
      function() {
        ...
        if (Cinnamenu.appsMenuButton) {
          if (Cinnamenu.appsMenuButton._categoryWorkspaceMode == CategoryWorkspaceMode.CATEGORY)
            Cinnamenu.appsMenuButton.toggleCategoryWorkspaceMode();
        }
      }));
  ...
  shellWorkspaceLaunch: function(params) {
    ...
    if (Cinnamenu.appsMenuButton) {
      if (Cinnamenu.appsMenuButton.menu.isOpen)
        Cinnamenu.appsMenuButton.menu.toggle();
    }
  }
};
...
PanelMenuButton.prototype = {
  ...
  _adjustThemeForCompatibility: function() {
    ...
    return false;
    Main._logInfo(Object.keys(this._dummySeparator))
  ...
  _calculateApplicationsBoxWidth: function() {
    ...
    let userGroupBoxMargin = {
      left: 0,
      top: 0,
      bottom: 0,
      right: 0
    };
    let userGroupBoxBorder = {
      left: 0,
      top: 0,
      bottom: 0,
      right: 0
    };
    let userGroupBoxPadding = {
      left: 0,
      top: 0,
      bottom: 0,
      right: 0
    ...
    let scrollWidth = gridWidth + scrollBoxBorder.left + scrollBoxBorder.right + scrollBoxPadding.left +
        ...
        if (refresh || !this._applications[app]) {
          if (viewMode == ApplicationsViewMode.LIST) { // ListView
            ...
            appListButton.actor.connect('enter-event', Lang.bind(this, function() {
              ...
              if (appListButton._app.get_description()) this.selectedAppDescription.set_text(appListButton._app
                .get_description());
            ...
            appGridButton.actor.connect('enter-event', Lang.bind(this, function() {
              appGridButton.actor.add_style_class_name('menu-application-button-selected');
              this.selectedAppTitle.set_text(appGridButton._app.get_name());
              if (appGridButton._app.get_description()) this.selectedAppDescription.set_text(appGridButton._app
                .get_description());
              else this.selectedAppDescription.set_text('');
            }));
            appGridButton.actor.connect('leave-event', Lang.bind(this, function() {
              appGridButton.actor.remove_style_class_name('menu-application-button-selected');
              this.selectedAppTitle.set_text('');
              this.selectedAppDescription.set_text('');
            }));
  ...
  selectActiveContainerItem: function(symbol, code, isFromSearch) {
    ...
    if (symbol && symbol == Clutter.KEY_Up) {
      ...
      if (this._activeContainer == this.applicationsListBox || this._activeContainer == this.applicationsGridBox ||
        ...
        return true;
      } else if (this._activeContainer == this.userGroupBox || this._activeContainer == this.viewModeBox || this._activeContainer ==
    ...
    if (this._activeContainer == this.shortcutsBox || this._activeContainer == this.applicationsListBox || this._activeContainer ==
      ...
      if (itemActor._delegate._type == ApplicationType.APPLICATION) {
        ...
        if (itemActor._delegate._app.get_description()) this.selectedAppDescription.set_text(itemActor._delegate._app
          .get_description());
        else this.selectedAppDescription.set_text('');
  ...
  _display: function() {
    ...
    // UserGroupBox
    this.userGroupBox = new St.BoxLayout({
    ...
    if (this._applet.shortcutsDisplay == ShortcutsDisplay.PLACES) {
      ...
      this.placesCategory = new GroupButton(this, null, null, _('Places'), {
        style_class: 'menu-category-button'
      });
    }
    ...
    this.placesCategory.setButtonPressCallback(Lang.bind(this, function() {
    ...
    if (recentEnabled) {
      this.userGroupBox.add(this.recentCategory.actor, {
        x_fill: false,
        y_fill: false,
        x_align: St.Align.MIDDLE,
        y_align: St.Align.MIDDLE
      ...
      this.recentCategory = new GroupButton(this, null, null, '      ', {
        style_class: 'cinnamenu-user-group-button'
      }); // dummy version
      this.userGroupBox.add(this.recentCategory.actor, {
        x_fill: false,
        y_fill: false,
    ...
    this.userGroupBox.add(this.webBookmarksCategory.actor, {
      x_fill: false,
      y_fill: false,
      x_align: St.Align.MIDDLE,
      y_align: St.Align.MIDDLE
    ...
    this.toggleStartupAppsView = new GroupButton(this, 'view-toggle-apps-symbolic', viewModeButtonIconSize, null, {
      style_class: 'menu-category-button'
    });
    this.toggleStartupAppsView.setButtonEnterCallback(Lang.bind(this, function() {
      this.toggleStartupAppsView.actor.add_style_class_name('menu-category-button-selected');
    ...
    this.toggleStartupAppsView.setButtonLeaveCallback(Lang.bind(this, function() {
      this.toggleStartupAppsView.actor.remove_style_class_name('menu-category-button-selected');
      this.selectedAppTitle.set_text(_('Toggle Startup Apps View'));
      this.selectedAppDescription.set_text('');
    }));
    ...
    this.toggleStartupAppsView.setButtonReleaseCallback(Lang.bind(this, function() {
      ...
      this.selectedAppTitle.set_text(_('Toggle Startup Apps View'));
      this.selectedAppDescription.set_text('');
      this._applet.startupAppsDisplay = this._applet.startupAppsDisplay + 1;
      if (this._applet.startupAppsDisplay > StartupAppsDisplay.FAVORITES) {
        this._applet.startupAppsDisplay = StartupAppsDisplay.ALL;
      }
      this._applet.settings.setValue('startup-apps-display', this._applet.startupAppsDisplay);
      this._resetDisplayApplicationsToStartup();
    }));
    ...
    for (let i = 0, len = shortcuts.length; i < len; i++) {
      ...
      shortcutButton.actor.connect('enter-event', Lang.bind(this, function() {
        ...
        if (this._applet.shortcutsDisplay == ShortcutsDisplay.PLACES) {
          ...
          if (shortcutButton._app.get_description()) this.selectedAppDescription.set_text(shortcutButton._app
            .get_description());
          else this.selectedAppDescription.set_text('');
        }
      }));
    ...
    */
    ...
    favAppCategory.setButtonReleaseCallback(Lang.bind(this, function() {
      ...
      this._applet.startupAppsDisplay = StartupAppsDisplay.FAVORITES;
      this._selectCategory(favAppCategory);
      this.selectedAppTitle.set_text(favAppCategory.label.get_text());
      this.selectedAppDescription.set_text('');
    }));
    ...
    let systemRestart = new GroupButton(this, 'refresh-symbolic', powerGroupButtonIconSize, null, {
      style_class: 'menu-favorites-button'
    });
    systemRestart.setButtonEnterCallback(Lang.bind(this, function() {
      systemRestart.actor.add_style_class_name('selected');
      this.selectedAppTitle.set_text(_('Restart Cinnamon'));
      this.selectedAppDescription.set_text('');
    }));
    systemRestart.setButtonLeaveCallback(Lang.bind(this, function() {
      systemRestart.actor.remove_style_class_name('selected');
      this.selectedAppTitle.set_text('');
      this.selectedAppDescription.set_text('');
    }));
    systemRestart.setButtonPressCallback(Lang.bind(this, function() {
      systemRestart.actor.add_style_pseudo_class('pressed');
    }));
    systemRestart.setButtonReleaseCallback(Lang.bind(this, function() {
    ...
    let systemShutdown = new GroupButton(this, 'system-shutdown', powerGroupButtonIconSize, null, {
      style_class: 'menu-favorites-button'
    });
    ...
    let logoutUser = new GroupButton(this, 'user-logout-symbolic', powerGroupButtonIconSize, null, {
      style_class: 'menu-favorites-button'
    });
    ...
    let lockScreen = new GroupButton(this, 'system-lock-screen', powerGroupButtonIconSize, null, {
      style_class: 'menu-favorites-button'
    });
    ...
    this.powerGroupBox.add(systemRestart.actor, {
      x_fill: false,
      y_fill: false,
      x_align: St.Align.MIDDLE,
      y_align: St.Align.MIDDLE
    ...
    this.extensionPreferences = new GroupButton(this, 'control-center-alt-symbolic', powerGroupButtonIconSize, null, {
      style_class: 'menu-favorites-button'
    });
    ...
    this.bottomPane.add(this.extensionPreferences.actor, {
      x_fill: false,
      y_fill: false,
      x_align: St.Align.END,
      y_align: St.Align.MIDDLE
...
CinnamenuButton.prototype = {
  ...
  _bindSettingsChanges: function() {
    var settingsProps = [{
      ...
      {
        key: 'startup-apps-display',
        value: 'startupAppsDisplay',
        cb: null
      },
      {
        key: 'hide-categories',
